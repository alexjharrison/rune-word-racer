<template>
    <div class="flex-grow-0 flex-shrink-0 max-h-full pt-2 overflow-y-auto rounded-lg bg-opacity-40 basis-1/2"
        :class="{ ['bg-purple-500']: userDetails?.playerId === currentPlayerId }">
